            ...
            <form action="{{ route('admin.exam-schedule-update', $examSchedule->id) }}" method="POST">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="wave_name" name="wave_name" class="form-input" placeholder="e.g. Batch 1"
                            value="{{ old('wave_name', $examSchedule->wave_name) }}" required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="participant_quota" name="participant_quota" class="form-input"
                                placeholder="e.g. 100"
                                value="{{ old('participant_quota', $examSchedule->participant_quota) }}" min="1">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-input" required>
                                ...
                                <option value="active"
                                    {{ old('status', $examSchedule->status) == 'active' ? 'selected' : '' }}>Active
                                </option>
                                <option value="inactive"
                                    {{ old('status', $examSchedule->status) == 'inactive' ? 'selected' : '' }}>Inactive
                                </option>
                            </select>
