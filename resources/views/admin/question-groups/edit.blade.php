            ...
            <form action="{{ route('admin.question-groups.update', $questionGroup->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input"
                        ...
                        value="{{ old('name', $questionGroup->name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="duration" class="form-input" placeholder="Contoh: 30" min="1"
                        value="{{ old('duration', $questionGroup->duration) }}" required>
