...
@section('content')
    <style>
        ...
        .group-radio-wrap input[type="radio"] {
            width: 18px;
            height: 18px;
        }
        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.questions.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" class="form-input form-textarea" placeholder="Masukkan pertanyaan soal...">{{ old('question_text') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="group-radio-wrap">
                        @foreach ($groups as $group)
                            <label>
                                <input type="radio" name="question_group_id" value="{{ $group->id }}"
                                    data-type="{{ $group->type }}" onchange="toggleQuestionType()">
                ...
                <div class="form-group" id="score-field">
                    ...
                    <input type="number" name="score" id="score-input" class="form-input" placeholder="Masukkan skor..."
                            ...
                            <div class="answer-item">
                                ...
                                <div class="option-radio">
                                    <input type="radio" name="correct_answer" value="{{ $option }}"
                                        class="pu-correct-radio" {{ old('correct_answer') == $option ? 'checked' : '' }}>
                                </div>
                            </div>
                        @endforeach
                    </div>
