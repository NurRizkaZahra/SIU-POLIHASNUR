...
<style>
    ...
    .btn-video:hover  { background: #7c3aed; transform: scale(1.05); }
    ...
    .answer-option.correct .option-text { color: #065f46; font-weight: 600; }

    .correct-indicator { display: none; color: #10b981; font-weight: 700; font-size: 12px; }
    .answer-option.correct .correct-indicator { display: block; }
    ...
    .empty-icon  { width: 80px; height: 80px; margin: 0 auto 20px; color: #cbd5e1; }
    .empty-title { font-size: 20px; font-weight: 600; color: #64748b; margin-bottom: 10px; }
    .empty-text  { color: #94a3b8; margin-bottom: 20px; }
    ...
    @media (max-width: 768px) {
        ...
        .btn-add,
        .btn-add-group { flex: 1; justify-content: center; }

        /* Soal: nomor + konten tumpuk, aksi di bawah */
        .question-header {
            flex-direction: column;
            gap: 12px;
        }

        .question-header-inner { gap: 12px; }
    ...
    @media (max-width: 480px) {
        .questions-container { padding: 10px; }

        .question-card { padding: 14px; border-radius: 12px; }

        .question-text { font-size: 13.5px; }

        .btn-add,
        .btn-add-group { padding: 10px 14px; font-size: 13px; }

        .group-badge,
        .video-badge { font-size: 11px; padding: 4px 10px; }
                    ...
                    <div class="question-content">
                        ...
                        <div style="margin-top:10px;">
                            <img src="{{ asset('storage/'.$question->question_image) }}"
                                 style="max-width:220px;width:100%;border-radius:8px;border:1px solid #ddd;">
                        </div>
                        @endif

                        <div class="answers-list">
                            @php $choices = $question->answer_choices ?? []; @endphp
                                    ...
                                    <span class="option-text">
                                        @if(is_array($choices[$option]))
                                            @if(isset($choices[$option]['image']))
                                                <img src="{{ asset('storage/'.$choices[$option]['image']) }}"
