                ...
                <div class="question-card">
                    <div class="question-header">
                                ...
                                <div class="question-meta">
                                    ...
                                    @if ($question->video_tutorial)
                                        <span class="video-badge">
                                            <svg style="width:14px;height:14px;" fill="currentColor" viewBox="0 0 20 20">
                                                <path
                                                    d="M2 6a2 2 0 012-2h6a2 2 0 012 6v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
                                            </svg>
                                            Video Tutorial
                                        </span>
                                    @endif
                                ...
                                <div class="answers-list">
                                    ...
                                    @foreach (['A', 'B', 'C', 'D', 'E'] as $option)
                                        @if (isset($choices[$option]) && !empty($choices[$option]))
                                            <div
                                                class="answer-option {{ $option == $question->correct_answer ? 'correct' : '' }}">
                        ...
                        <div class="question-actions">
                            @if ($question->video_tutorial)
                                <a href="{{ $question->video_tutorial }}" target="_blank" class="btn-action btn-video"
                                    title="Lihat Video">
        ...
        @if ($questions->hasPages())
            <div class="pagination">
                ...
                @foreach ($questions->getUrlRange(1, $questions->lastPage()) as $page => $url)
                    <a href="{{ $url }}"
                        class="page-btn {{ $page == $questions->currentPage() ? 'active' : '' }}">
                        {{ $page }}
                    </a>
                @endforeach
