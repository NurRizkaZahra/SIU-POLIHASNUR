        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.questions.update', $question->id) }}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <textarea name="question_text" class="form-input form-textarea" placeholder="Masukkan pertanyaan soal...">{{ old('question_text', $question->question_text) }}</textarea>
                ...
                @if ($currentType == 'PSI')
                    <div class="form-group">
                        ...
                        @if ($question->question_image)
                            ...
                            <div class="form-hint" style="margin-bottom:8px;">Gambar saat ini. Upload baru untuk mengganti.
                            </div>
                        @endif
                        <input type="file" name="question_image" class="form-input"
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="score" class="form-input" placeholder="Masukkan skor..."
                        value="{{ old('score', $question->score) }}" step="0.1" min="0.1" required>
                            ...
                            <div class="answer-item">
                                ...
                                <div class="option-input">
                                    @if (isset($question->answer_choices[$option]['image']))
                                        ...
                                        <div class="form-hint" style="margin-bottom:6px;">Gambar saat ini. Upload baru untuk
                                            mengganti.</div>
                                    @endif
                                    <input type="file" name="answer_choices[{{ $option }}][image]"
                                        class="form-input" accept="image/png,image/jpg,image/jpeg">
                                </div>
                                <div class="option-radio">
                                    <input type="radio" name="correct_answer" value="{{ $option }}"
                                        {{ old('correct_answer', $question->correct_answer) == $option ? 'checked' : '' }}>
