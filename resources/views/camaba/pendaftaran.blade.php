        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="school_name"
                       value="{{ old('school_name', $user->educationData->school_name ?? '') }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="school_code"
                       value="{{ old('school_code', $user->educationData->school_code ?? '') }}"
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" name="number_of_children"
                       value="{{ $keluarga->number_of_children ?? '' }}"
