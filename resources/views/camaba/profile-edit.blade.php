...
@section('title', 'Edit Profile Camaba')
@section('page-title', 'EDIT PROFILE CAMABA')
    ...
    <div class="profile-container">
        <div class="profile-wrapper">
            ...
            <div class="profile-body">
                ...
                <form action="{{ route('camaba.profile.update') }}" method="POST" enctype="multipart/form-data"
                    id="editProfileForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" class="form-control" value="Camaba" disabled>
                                </div>
                    ...
                    <div class="footer-actions">
                        <a href="{{ route('camaba.profile') }}" class="btn-back">
