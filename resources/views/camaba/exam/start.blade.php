...
/* .profile-icon svg { ... } */
    ...
    .video-header-text p { margin: 0; }
    .vt-title { font-size: 13.5px; font-weight: 700; color: #1e293b; }
    .vt-sub   { font-size: 11.5px; color: #94a3b8; }
    ...
    <img src="{{ auth()->user()->photo 
        ...
        <div style="margin-top: 10px;">
            ...
            <div class="form-group" style="margin-bottom: 0;">
                ...
                <input type="text" value="{{ optional($schedule)->wave_name ?? 'Tidak diketahui' }}" class="form-input" readonly />
            </div>
        </div>
